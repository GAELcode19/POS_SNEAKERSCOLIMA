...
Route::middleware(['auth'])->group(function () {
    ...
    // Apartados — accesible para todos los empleados
    Route::get('pos/apartados', [LayawayController::class, 'index'])->name('pos.apartados');
    Route::post('pos/apartados', [LayawayController::class, 'store'])->name('pos.apartados.store');
    Route::post('pos/apartados/{layaway}/payment', [LayawayController::class, 'addPayment'])->name('pos.apartados.payment');
    Route::get('pos/apartados/{layaway}/folio', [LayawayController::class, 'folio'])->name('pos.apartados.folio');
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::get('pos/inventory/labels', [PosController::class, 'labelsAll'])->name('pos.inventory.labels');
        Route::get('pos/inventory/{product}/label', [PosController::class, 'label'])->name('pos.inventory.label');
