...
<div>
    <div class="inventory-header">
        ...
        <div class="page-header-right">
            ...
            <a href="{{ route('pos.inventory.labels', ['brand' => $brandFilter !== 'todos' ? $brandFilter : null]) }}" target="_blank" class="btn btn-secondary" style="text-decoration:none;">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:16px;height:16px;"><path d="M3 5h2M3 9h2M3 13h2M3 17h2M8 5v14M12 5v14M16 5v10M20 5v14"></path></svg>
                Etiquetas
            </a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:6px;">
                                ...
                                <a href="{{ route('pos.inventory.label', $product) }}" target="_blank" class="btn-edit-product" style="background:rgba(16,185,129,0.15);color:#10b981;text-decoration:none;" title="Imprimir etiqueta con código de barras">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:14px;height:14px;"><path d="M3 5h2M3 9h2M3 13h2M3 17h2M8 5v14M12 5v14M16 5v10M20 5v14"></path></svg>
                                    Etiqueta
                                </a>
